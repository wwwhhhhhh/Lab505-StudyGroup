...
class ForestUNet(nn.Module):
    def __init__(self, n_class, bilinear=False):
        super(ForestUNet, self).__init__()
        self.n_channels = 1
        self.n_class = n_class
        self.bilinear = bilinear
        ...
        self.pam_att1 = PamAtt(2048)
        self.pam_att2 = PamAtt(1024)
        self.pam_att3 = PamAtt(512)
        
        self.cam_att1 = CamAtt(128)
        self.cam_att2 = CamAtt(64)
